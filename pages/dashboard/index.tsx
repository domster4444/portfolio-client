  ...
  return (
    <div className="sidebar">
      ...
      <ul className="nav-list">
        ...
        <li>
          <a href="/welcome">
            <i className="bx bx-pie-chart-alt-2" style={{display:'flex',alignItems:'center',justifyContent:'center'}}>
        ...
        <li>
          <a href="/profile">
            <i style={{display:'flex',alignItems:'center',justifyContent:'center'}} className="bx  bx-user">
        ...
        <li>
          <a href="/themes">
            <i style={{display:'flex',alignItems:'center',justifyContent:'center'}} className="bx  bx-folder">
        ...
        <li>
          <a href="/videoguidance">
            <i style={{display:'flex',alignItems:'center',justifyContent:'center'}} className="bx  bx-chat">
        ...
        <li>
          <a href="/payment">
            <i style={{display:'flex',alignItems:'center',justifyContent:'center'}} className="bx  bx-cart-alt">
