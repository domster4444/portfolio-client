...
const Index = () => {
  const [messageSentStatus, setMessageSetStatus] = useState<boolean>(false);
  ...
  const sendEmail = (e: any) => {
    ...
    emailjs
      ...
      .then(
        (result) => {
          console.log(result.text); // Response as String "OK"
          setMessageSetStatus(true);
        },
        (error) => {
                ...
                if (messageSentStatus === false) {
                  ...
                  return (
                    <>
                      ...
                      >
                        Congratulation, you have successfully subscribed to our
                        news letter
                      </h3>
                    </>
                  );
