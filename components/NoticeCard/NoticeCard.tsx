      ...
      >
        ...
        <Modal.Body>
          <p className={NoticeCardStyles.modal__description}>
            ...
            system and does not require any physical or digital signatures. 1.
            ...
            access, register with or use this Site. 2. Conditions of use A. YOUR
            ...
            Democratic Republic of Nepal. You agree, as we do, to submit to the
            exclusive jurisdiction of the courts in Katmandu.
          </p>
        </Modal.Body>
        <Modal.Footer>
